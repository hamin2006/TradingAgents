...
def companyfacts(ticker="REGN", cik="0000872589"):
    ...
    us_gaap = {
        ...
        "Revenues": fact_tag([
            fact_row("2025-07-01", "2025-09-30", 3800, "2025-10-23", "10-Q", 2025, "Q3", "CY2025Q3"),
            fact_row("2025-10-01", "2025-12-31", 3900, "2026-02-12", "10-K", 2025, "Q4", "CY2025Q4"),
            fact_row("2026-01-01", "2026-03-31", 4000, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 4290, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "GrossProfit": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 3300, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 3540, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "OperatingIncomeLoss": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 900, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 1180, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "NetIncomeLoss": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 700, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 900, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "NetCashProvidedByUsedInOperatingActivities": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 1100, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 1250, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "PaymentsToAcquirePropertyPlantAndEquipment": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 150, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 160, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "PaymentsForRepurchaseOfCommonStock": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 500, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 550, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "PaymentsOfDividends": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 90, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 95, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        "DepreciationDepletionAndAmortization": fact_tag([
            fact_row("2026-01-01", "2026-03-31", 120, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1"),
            fact_row("2026-04-01", "2026-06-30", 125, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2"),
        ]),
        # Annual rows for the FY frame fallback path
        "Revenues_fy": fact_tag([
            fact_row("2025-01-01", "2025-12-31", 15200, "2026-02-12", "10-K", 2025, "FY", "CY2025"),
        ]),
        # Balance-sheet instants (quarter-end frames CYyyyyQqI)
        "Assets": fact_tag([
            fact_row(None, "2026-03-31", 32000, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1I"),
            fact_row(None, "2026-06-30", 33000, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2I"),
        ]),
        "Liabilities": fact_tag([
            fact_row(None, "2026-03-31", 10000, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1I"),
            fact_row(None, "2026-06-30", 10100, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2I"),
        ]),
        "StockholdersEquity": fact_tag([
            fact_row(None, "2026-03-31", 22000, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1I"),
            fact_row(None, "2026-06-30", 22900, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2I"),
        ]),
        "CashAndCashEquivalentsAtCarryingValue": fact_tag([
            fact_row(None, "2026-03-31", 5000, "2026-04-24", "10-Q", 2026, "Q1", "CY2026Q1I"),
            fact_row(None, "2026-06-30", 5200, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2I"),
        ]),
        "LongTermDebtNoncurrent": fact_tag([
            fact_row(None, "2026-06-30", 6000, "2026-07-24", "10-Q", 2026, "Q2", "CY2026Q2I"),
        ]),
    }
    dei = {
